  ...
  render = () => {
    return [
      <div>
        ...
        <p>De blazerssectie in de vorm van “The Longhorns” is een welkome aanvulling, een frisse wind er doorheen. What the Frnk, een lekkere live band voor elk zichzelf respecterende kroeg of festival.</p>
